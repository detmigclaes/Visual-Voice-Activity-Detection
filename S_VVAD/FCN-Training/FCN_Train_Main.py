...
tf.compat.v1.flags.DEFINE_string('train_dir', './FCN_Traind/TrainSet1111/',
                           """Directory where to write event logs """
                           """and checkpoint.""")
tf.compat.v1.flags.DEFINE_float('learning_rate', 0.5e-4, "learning rate.") #1e-5#1e-4
tf.compat.v1.flags.DEFINE_integer('batch_size', 4, "batch size")
tf.compat.v1.flags.DEFINE_integer('max_steps', 1000, "max steps")#500000
